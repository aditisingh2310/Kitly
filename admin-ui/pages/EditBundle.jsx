  ...
  const fetchBundle = async () => {
    try {
      ...
      if (data.bundle) {
        ...
        setHandle(data.bundle.handle);
        setSelectedProducts(data.bundle.products || []);
        setDiscountType(data.bundle.discount_type);
        setDiscountValue(data.bundle.discount_value.toString());
        setActive(data.bundle.active);
      }
    } catch (error) {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        showToast(error.error || 'Failed to update bundle', true);
      }
    } catch (error) {
      console.error('Error updating bundle:', error);
      showToast('Failed to update bundle', true);
    } finally {
      setSaving(false);
    }
  };
